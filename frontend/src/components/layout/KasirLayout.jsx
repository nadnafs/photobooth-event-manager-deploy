...
import { LayoutDashboard, Calendar, Users, ShoppingBag, LogOut, Check, BookOpen, CreditCard, ListCollapse, Monitor } from 'lucide-react';
...
const KasirLayout = () => {
  ...
  const navItems = [
    { name: 'Dashboard', path: '/kasir/dashboard', icon: LayoutDashboard },
    { name: 'Pendaftaran Baru', path: '/kasir/daftar', icon: ListCollapse },
    { name: 'Transaksi', path: '/kasir/transactions', icon: ShoppingBag },
    { name: 'Kelola Event', path: '/kasir/events', icon: Calendar },
    { name: 'Pengambilan Pesanan', path: '/kasir/pickup', icon: Check },
    { name: 'Panduan Kasir', path: '/kasir/info', icon: BookOpen },
  ...
  return (
    <div className="flex h-screen bg-background">
      ...
      <div className="w-64 bg-card border-r border-border flex flex-col">
        <div className="p-6">
          <h2 className="text-xl font-bold text-primary">Photobooth System</h2>
